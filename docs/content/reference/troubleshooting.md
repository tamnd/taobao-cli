...
Most of these come down to network reality or how taobao serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

taobao rate-limits like any public site. taobao already paces
...
Where a surface is gated, taobao reads a cookie or token you supply
...
`taobao`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what taobao actually did
