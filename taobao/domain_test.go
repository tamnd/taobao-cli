...
// HTTP behaviour is covered in taobao_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "taobao://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("taobao", "about")
	if err != nil || got.String() != "taobao://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want taobao://page/about", got.String(), err)
	}
}
